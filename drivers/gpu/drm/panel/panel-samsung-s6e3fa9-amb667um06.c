...
static void s6e3fa9_amb667um06_reset(struct s6e3fa9_amb667um06 *ctx)
{
	...
	// TODO: disable this for now due to screen turning off ireversibly
...
static const struct of_device_id s6e3fa9_amb667um06_of_match[] = {
	{ .compatible = "samsung,s6e3fa9-amb667um06" },
	{ /* sentinel */ }
};
...
static struct mipi_dsi_driver s6e3fa9_amb667um06_driver = {
	...
	.driver = {
		.name = "panel-samsung-s6e3fa9-amb667um06",
		.of_match_table = s6e3fa9_amb667um06_of_match,
	},
};
module_mipi_dsi_driver(s6e3fa9_amb667um06_driver);

MODULE_AUTHOR("Waldemar Tomme <waldetomme@gmail.com>");
MODULE_DESCRIPTION("DRM driver for Samsung panel AMB667UM06 with S6E3FA9 controller");
MODULE_LICENSE("GPL");
